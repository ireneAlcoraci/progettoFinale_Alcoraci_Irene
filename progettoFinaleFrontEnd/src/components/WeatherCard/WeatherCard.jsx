        ...
        <div className="col">
            <div className="card m-2" style={{ width: "18rem}" }}>
                <div className="card-body">
                    ...
                    <p className="card-subtitle mb-2 text-body-secondary">temperatura massima: {props.maxTemp} </p>
                    <p className="card-subtitle mb-2 text-body-secondary">temperatura minima: {props.minTemp} </p> 
